...
contract('ERC1155Supply', function (accounts) {
  ...
  beforeEach(async function () {
    this.token = await ERC1155SupplyMock.new(uri,"Fire-Zard-Supply-Test","fzst");
  });
...
//	console.log("+++++++++++++++++++++++++++++++++++++++++++++++++++++++");
//	var supply = await this.token.totalSupply(firstTokenId);
//	var supply = await this.token.methods['totalSupply(uint256)'](firstTokenId);
//	console.log(supply);
